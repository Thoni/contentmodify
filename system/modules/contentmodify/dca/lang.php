 ...
 */
$GLOBALS['TL_DCA']['tl_contentmodify']['config']['onsubmit_callback'] = array(array('tl_contentmodify', 'updateTypeL'));

$GLOBALS['TL_DCA']['tl_contentmodify']['list']['sorting']['filter'] = array(array('type=?','l'));

$GLOBALS['TL_DCA']['tl_contentmodify']['fields']['text']['label'] = &$GLOBALS['TL_LANG']['tl_contentmodify']['textL'];
$GLOBALS['TL_DCA']['tl_contentmodify']['fields']['text']['eval'] = array('tl_class'=>'w50', 'mandatory'=>true, 'maxlength'=>100);

$GLOBALS['TL_DCA']['tl_contentmodify']['fields']['class']['label'] = &$GLOBALS['TL_LANG']['tl_contentmodify']['sprache'];
