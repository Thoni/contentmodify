...
$GLOBALS['TL_DCA']['tl_contentmodify']['config']['onsubmit_callback'] = array(array('tl_contentmodify', 'updateTypeB'));

$GLOBALS['TL_DCA']['tl_contentmodify']['list']['sorting']['filter'] = array(array('type=?','b'));

$GLOBALS['TL_DCA']['tl_contentmodify']['fields']['text']['label'] = &$GLOBALS['TL_LANG']['tl_contentmodify']['textB'];
